...
def main() -> NoReturn:
    while True:
        ...
        if pot_pos > 10:
            falcon1.set(TalonFXControlMode.PercentOutput, pot_pos / pot_range)
            falcon2.set(TalonFXControlMode.PercentOutput, pot_pos / pot_range)
            falcon3.set(TalonFXControlMode.PercentOutput, pot_pos / pot_range)
            falcon4.set(TalonFXControlMode.PercentOutput, pot_pos / pot_range)
            falcon5.set(TalonFXControlMode.PercentOutput, pot_pos / pot_range)
            falcon6.set(TalonFXControlMode.PercentOutput, pot_pos / pot_range)
            ...
            falcon3.set(TalonFXControlMode.PercentOutput, 0)
            falcon4.set(TalonFXControlMode.PercentOutput, 0)
            falcon5.set(TalonFXControlMode.PercentOutput, 0)
            falcon6.set(TalonFXControlMode.PercentOutput, 0)
